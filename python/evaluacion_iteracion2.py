...
-----------------------
Evaluación del Random Forest con magnitud.

Salida:
    resultados/iteracion_2/metricas.txt
    resultados/iteracion_2/matriz_confusion.csv
"""
...
def evaluar():
    ...
    print("=" * 60)
    print("       RITMOEDGE - EVALUACIÓN ITERACIÓN 2")
    print("=" * 60)
    ...
    if not ARCHIVO_MODELO.exists():
        ...
        raise FileNotFoundError(
            "No existe modelo_iteracion_2.pkl."
        )
